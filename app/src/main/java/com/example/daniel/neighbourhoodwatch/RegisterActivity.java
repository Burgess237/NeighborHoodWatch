...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private ImageButton profilePicImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //profilePicImg.setImageURI(null);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password,displayName,imageUri);
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password,String displayName,Uri photo) {
            mEmail = email;
            mPassword = password;
